...
INITIAL_NOTES_ROGERS = {
    ...
    "Great Lakes Conservative Fund (GLCF), Inc.": "Michigan conservative group; FEC filing lists Rogers' own Team Rogers JFC as its affiliated committee",
    ...
    "First Principles Digital": "Conservative digital group aligned with Sen. Cynthia Lummis (WY) -- FEC filing lists her Lummis Victory Committee as affiliated",
    ...
    "High Plains PAC": "GOP group aligned with Sen. John Barrasso (WY) -- FEC filing lists his Barrasso Victory committee as affiliated",
...
INITIAL_NOTES_ELSAYED = {
    "WinSenate": "Democratic group; FEC filing lists Senate Majority PAC (SMP) as its affiliated committee",
